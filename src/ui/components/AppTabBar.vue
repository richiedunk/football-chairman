...
// Messages sits in the middle. It is the interrupt channel — the thing that
// actually drives a week — and it was fourth of five, which is the worst place
// on a phone to put the tab somebody reaches for most.
const tabs = [
  ...
  { id: 'inbox', label: 'Messages', to: '/inbox', d: 'M4 4h16v16H4zM4 8l8 5 8-5' },
